...
- [ ] **6.2 Artifact Storage & Log Independence**: Ensure artifacts are independent of operational logs and databases; deleting the DB must not invalidate artifacts.
